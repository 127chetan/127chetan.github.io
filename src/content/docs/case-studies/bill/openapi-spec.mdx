...
The final OpenAPI spec was split into 10 files, covering 300+ endpoints across core BILL operations.

| Domain | Spec file coverage | Endpoints (approx) |
|---|---|---|
...
| Classifications | Chart of accounts, accounting class, location, department, payment terms | — |
