...
:::note[The split decision]
Even with live linting, maintaining a single 178,000-line spec file would eventually become unmanageable. Halfway through the effort, my powerful work machine was struggling to respond. I made the decision early to split the spec into smaller files organized by BILL's core workflows.
:::
